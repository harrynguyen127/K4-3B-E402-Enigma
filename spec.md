...
| 18/09/2026 | Bổ sung kết quả User Validation 4 bạn ngoài nhóm (`validation/user-validation.md`), đưa cải tiến vào backlog/prototype (phân tầng độ khó câu hỏi, loading spinner đo độ trễ 10s) | Phản hồi thực tế theo chuẩn 4.2 từ Minh Tâm (UI/UX), Khánh Linh (độ trễ AI & câu hỏi nhiều đáp án), Viết Đức (độ sâu kỹ thuật & roadmap), Bạn 4 (độ khó câu hỏi Non-tech & đo độ trễ 10s) |