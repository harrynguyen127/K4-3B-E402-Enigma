...
| **Nguyễn Hoàng Cường**<br>*(Học viên Non-Tech — Willing user CP1)* | Làm thử 10 câu quiz trên web và quan sát thời gian trả kết quả của AI | Thao tác bền bỉ qua 10 câu; gặp khó khăn do đề còn nặng tính kỹ thuật với người trái ngành; ghi nhận chính xác thời gian chờ AI (~10s/câu) | - *Đọc giải thích:* **"Tôi đã sử dụng và thấy ứng dụng trả lời đưa đáp án rất dễ hiểu"**<br>- *Khó chịu / Khó khăn nhất:* **"Câu quá khó với non-tech như tôi làm 10 câu chưa thấy câu nào dễ, thời gian kiểm tra và trả đáp án hơi lâu chắc khoảng mất 10 giây cho 1 câu"**<br>- *Đề xuất cải thiện:* **"Cải thiện tốc độ phản hồi, câu trả lời dễ hơn"**<br>- *Disappointment:* **Hơi tiếc** | **Nghiêm trọng** *(Độ khó câu hỏi cho Non-tech & Độ trễ phản hồi ~10s)* |
| *(Bạn test 5 - nếu có)* | | | | |
...
1. **Chủ đề lặp nhiều nhất:**  
   - **Đánh giá cao:** 100% người học (cả 4 bạn) đều khẳng định **nội dung AI giải thích rất dễ hiểu, đúng trọng tâm và hữu ích**.  
   - **Sự phân hoá sâu sắc giữa các Persona (Minh chứng cốt lõi của đề tài D2):**  
     + Học viên **IT/Dev** (Viết Đức) thấy câu hỏi trắc nghiệm *quá dễ, chọn bừa cũng trúng, đòi hỏi câu hỏi code/tính toán*.  
     + Trong khi học viên **Non-tech** (Hoàng Cường) lại thấy *10 câu đều quá khó, làm 10 câu chưa thấy câu nào dễ*.  
     $\rightarrow$ Đây là **bằng chứng thực nghiệm đắt giá nhất** khẳng định sự cần thiết của tính năng phân tầng câu hỏi và cá nhân hóa giải thích theo hồ sơ học viên!  
   - **Vấn đề chung:** Độ trễ khi AI sinh phản hồi thật còn chậm (*Khánh Linh: "chấm chậm"*, *Hoàng Cường: "mất khoảng 10 giây cho 1 câu"*).
2. **1–2 thay đổi làm trước demo (đưa vào Changelog `spec.md §9`):**  
   - **Thay đổi 1:** Điều chỉnh độ khó câu hỏi thích ứng theo Persona (câu hỏi cho Non-IT giảm bớt thuật ngữ kỹ thuật sâu; câu hỏi cho Dev tăng tính thực hành).  
   - **Thay đổi 2:** Thêm hiệu ứng loading / thông báo ước tính thời gian xử lý (~8-10s) khi AI đang chấm để người học yên tâm chờ đợi.
3. **Điểm giữ nguyên có lý do (đối chiếu nguyên lý thiết kế):**  
   - Giữ nguyên cơ chế gọi model AI thật trực tiếp và trích dẫn chuẩn transcript bài giảng (thay vì dùng mock phản hồi tức thì nhưng thiếu trung thực).
4. **Đưa vào Backlog (để trình bày trên Slide 6 — CP5):**  
   - Tối ưu Streaming responses (chữ hiện ra dần dần) và Caching các câu hỏi phổ biến để giảm độ trễ từ 10s xuống < 3s.  
   - Phân cấp ngân hàng câu hỏi theo 3 mức độ (Cơ bản cho Non-IT $\rightarrow$ Trung cấp cho Data $\rightarrow$ Nâng cao kèm code cho Dev).

---

## 3. Chỉ Số Định Lượng Rút Ra (Đưa vào Slide kết quả CP5)

- **Số người đã thử nghiệm:** **4 bạn** (gồm 1 willing user đã khai báo ở CP1: *Nguyễn Hoàng Cường* + 3 bạn đổi chéo ngoài nhóm: *Đinh Thị Minh Tâm, Nguyễn Khánh Linh, Nguyễn Viết Đức*).
- **Mức độ hiểu bài:** **100% (4/4 bạn)** đánh giá nội dung giải thích *"Rất dễ hiểu / Dễ hiểu"*.
- **Con số thực tế về hiệu năng:** Đo lường được độ trễ thực tế của hệ thống là **~10 giây/câu**, làm cơ sở định lượng cho kế hoạch tối ưu kỹ thuật ở vòng sau.
